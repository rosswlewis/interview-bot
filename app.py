...
if st.session_state.feedback_shown:
    ...
    feedback_completion = feedback_client.chat.completions.create(
        model="gpt-4o",
        messages=[
            {'role': 'system', 'content': """You are a helpful tool that provies feedback on an interviewee performance.
            Before the feedback give a score of 1 to 10.
            Follow this format:
            Overal score: //Your score
            Feedbcak: //Here you put your feedback
            Give only the feedback, do not ask any additional questions."""},
            {'role': 'user', 'content': f"This si the interview you need to evaluate.  Keep in mind that you are only a tool and shouldn't engage in conversation: {conversation_history}"}
        ]
    )
